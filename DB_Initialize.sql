...
ELSE
    ...
    -- customer holding insert--
   INSERT INTO CUSTOMERHOLDING(SECURITYID,QTY,CUSTOMERID,COMPANYID,asofdate) VALUES(1,3,1,1,SYSDATE);
INSERT INTO CUSTOMERHOLDING(SECURITYID,QTY,CUSTOMERID,COMPANYID,asofdate) VALUES(2,4,2,2,SYSDATE);
INSERT INTO CUSTOMERHOLDING(SECURITYID,QTY,CUSTOMERID,COMPANYID,asofdate) VALUES(3,5,3,3,SYSDATE);
INSERT INTO CUSTOMERHOLDING(SECURITYID,QTY,CUSTOMERID,COMPANYID,asofdate) VALUES(4,6,4,4,SYSDATE);
INSERT INTO CUSTOMERHOLDING(SECURITYID,QTY,CUSTOMERID,COMPANYID,asofdate) VALUES(5,7,5,5,SYSDATE);
COMMIT;
